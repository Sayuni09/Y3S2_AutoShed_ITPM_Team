...
import { loginLicUser } from "../services/lic_authService";
import "../styles/loginForms.css";

const LicLoginForm = ({ onLoginSuccess, onBack }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const data = await loginLicUser(email, password);
