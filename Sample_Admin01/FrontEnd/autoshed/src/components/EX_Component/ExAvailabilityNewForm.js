...
import '../../styles/EX_Styles/Ex_Avalability_New_Form.css';

const ExAvailabilityNewForm = () => {
    const [user, setUser ] = useState({ examiner_id: '' });
    ...
    useEffect(() => {
        ...
        if (token) {
            ...
            setUser ({ name: decodedToken.name, examiner_id: decodedToken.id });
        }
    }, []);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await exAvailabilityService.submitAvailability(user.examiner_id, comments, availabilityDates);
    ...
    return (
        <div className="availability-form-container">
            <form onSubmit={handleSubmit} className="availability-form">
                <h2 className="form-title">Examiner Availability Form</h2>
...
export default ExAvailabilityNewForm;