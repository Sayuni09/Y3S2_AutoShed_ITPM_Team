...
import '../../styles/LEC_Styles/LecEmail.css';
import { X, Clock, Send, Reply, Trash } from 'lucide-react';

const LecEmail = ({ isOpen, onClose, userEmail }) => {
    ...
    useEffect(() => {
        setEmails([
            {
                id: 1,
                from: 'hod@autoshed.com',
                to: userEmail,
                subject: 'Course Material Review Request',
                message: 'Dear Lecturer,\n\nPlease review the updated course materials for the upcoming semester. We need your feedback by the end of this week.\n\nBest regards,\nHead of Department',
                time: '2 hours ago',
                status: 'unread',
                thread: []
            },
            {
                id: 2,
                from: 'coordinator@autoshed.com',
                to: userEmail,
                subject: 'Examination Paper Submission',
                message: 'Hello,\n\nThis is a reminder to submit your examination papers for the upcoming final examinations. The deadline is next Friday.\n\nRegards,\nExam Coordinator',
                time: '5 hours ago',
                status: 'unread',
                thread: []
            },
            {
                ...
                to: userEmail,
                subject: 'Teaching Schedule Update',
                message: 'Dear Lecturer,\n\nYour teaching schedule for next semester has been finalized. Please review and confirm your availability.\n\nThank you,\nAdmin Team',
                time: '1 day ago',
                status: 'read',
                thread: []
            }
