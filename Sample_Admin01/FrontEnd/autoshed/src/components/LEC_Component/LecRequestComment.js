...
import '../../styles/LEC_Styles/LecRequestComment.css';
import LecRequestService from '../../services/LEC_Services/LecRequestService';

const LecRequestComment = ({ schedule, onClose, onSubmit, lecturerId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await LecRequestService.submitRescheduleRequest(
      ...
      <div className="request-comment-modal">
        ...
        <div className="schedule-details">
          <div className="module-info">
            ...
            <span>{schedule.module_name}</span>
          </div>
...
export default LecRequestComment;